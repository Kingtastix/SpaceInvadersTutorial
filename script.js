...
class Player {
    constructor(){
        ...
        image.onload = () => {
            ...
            this.position = {
                ...
                y: canvas.height - this.height - 55
            };
        }
    }
    ...
    draw() {
        ...
        //Making the center of the player become the Canvas
...
function animate() {
    ...
    //Invader Projectiles array
    invaderProjectiles.forEach((invaderProjectile, z) => {
        invaderProjectile.update();
        //Remove projectiles
        if(invaderProjectile.position.y + invaderProjectile.height >= canvas.height){
            setTimeout(() => {
                invaderProjectiles.splice(z, 1);
            }, 0)
        } else {
            invaderProjectile.update();
        }
    ...
    //console.log(invaderProjectiles.length);
                    ...
                    setTimeout(() => {
                        ...
                        if(invaderFound && projectileFound){
                            ...
                            if(grid.invaders.length > 0){
                                ...
                                //Updates the right side of the grid
                                grid.width = lastInvader.position.x - firstInvader.position.x + lastInvader.width;
                                 //Updates the left side of the grid
